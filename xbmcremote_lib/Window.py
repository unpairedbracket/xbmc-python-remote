...
'''
This class is meant to be subclassed by XbmcremoteWindow.  It provides common
functions and some boilerplate.
'''
...
class Window(Gtk.Window): # pylint: disable=W0232
    ...
    def __new__(cls):
        ...
        new_object = builder.get_object("remote_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a XbmcremoteWindow object with it in order to finish
        initializing the start of the new XbmcremoteWindow instance.
        '''
        # Get a reference to the builder and set up the signals.
        self.builder = builder
        self.ui = builder.get_ui(self, True)
        self.PreferencesDialog = None # class # pylint: disable=C0103
        self.preferences_dialog = None # instance
        self.AboutDialog = None # class # pylint: disable=C0103
        self.ErrorDialog = None # class # pylint: disable=C0103
    ...
    def on_mnu_about_activate(self, widget, data=None):
        '''Display the about box for xbmcremote.'''
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        '''
        Display the preferences window for xbmcremote.
        ...
        if self.preferences_dialog is not None:
            ...
            self.preferences_dialog = self.PreferencesDialog() # pylint: disable=E1102,C0301
    ...
    def on_mnu_close_activate(self, widget, data=None):
        '''Signal handler for closing the XbmcremoteWindow.'''
        self.destroy()
    ...
    @staticmethod
    def on_preferences_changed(settings, key, data=None):
